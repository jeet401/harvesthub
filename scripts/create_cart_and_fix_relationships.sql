...
-- Create policy for buyers to view all active products
CREATE POLICY "Buyers can view all active products" ON public.products
    FOR SELECT USING (is_active = true);

-- Create policy for buyers to view farmer profiles (for product listings)
CREATE POLICY "Users can view farmer profiles" ON public.profiles
    FOR SELECT USING (user_type = 'farmer');

-- Create policy for buyers to view categories
